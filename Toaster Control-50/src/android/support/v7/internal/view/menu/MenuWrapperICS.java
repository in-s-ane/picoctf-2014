    ...
    implements SupportMenu
{
            ...
            MenuItem amenuitem[])
    {
        ...
        int i1 = ((Menu)mWrappedObject).addIntentOptions(i, j, k, componentname, aintent, intent, l, amenuitem1);
        if (amenuitem1 != null)
        {
            int j1 = 0;
            for (int k1 = amenuitem1.length; j1 < k1; j1++)
            {
                amenuitem[j1] = getMenuItemWrapper(amenuitem1[j1]);
            }
