...
_L15:
        ...
        {
            k5 = android.view.View.MeasureSpec.makeMeasureSpec(k1, 0x80000000);
        } else
        if (layoutparams1.height == -1)
        {
            k5 = android.view.View.MeasureSpec.makeMeasureSpec(k1, 0x40000000);
        } else
        {
...
_L9:
                    ...
                    if (view.getVisibility() != 8)
                    {
                        ...
                        if (flag && view != mSlideableView)
                        {
                            if (layoutparams.width < 0 && (k3 > i3 || layoutparams.weight > 0.0F))
                            {
                                ...
                                if (flag1)
                                {
                                    ...
                                    {
                                        l4 = android.view.View.MeasureSpec.makeMeasureSpec(k1, 0x80000000);
                                    } else
                                    if (layoutparams.height == -1)
                                    {
                                        l4 = android.view.View.MeasureSpec.makeMeasureSpec(k1, 0x40000000);
                                    } else
                                    {
                        ...
                        if (layoutparams.weight > 0.0F)
                        {
                            ...
                            if (layoutparams.width == 0)
                            {
                                if (layoutparams.height == -2)
                                {
                                    l3 = android.view.View.MeasureSpec.makeMeasureSpec(k1, 0x80000000);
                                } else
                                if (layoutparams.height == -1)
                                {
                                    l3 = android.view.View.MeasureSpec.makeMeasureSpec(k1, 0x40000000);
                                } else
                                {
        ...
        setMeasuredDimension(l, l1 + getPaddingTop() + getPaddingBottom());
        mCanSlide = flag;
