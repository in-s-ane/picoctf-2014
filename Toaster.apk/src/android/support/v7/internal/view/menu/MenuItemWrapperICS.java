    ...
    implements SupportMenuItem
{
    ...
    {
        boolean flag = mLastRequestVisible;
        boolean flag1 = false;
        if (flag)
        {
            ...
            {
                boolean flag2 = actionprovider.overridesItemVisibility();
                flag1 = false;
                if (flag2)
                {
                    boolean flag3 = actionprovider.isVisible();
                    flag1 = false;
                    if (!flag3)
                    {
    ...
    public MenuItem setActionView(View view)
    {
        ...
        ((MenuItem)mWrappedObject).setActionView(view);
        return this;
    }
    ...
    public void setExclusiveCheckable(boolean flag)
    {
        try
        {
            ...
            {
                Class class1 = ((MenuItem)mWrappedObject).getClass();
    ...
    public MenuItem setOnMenuItemClickListener(android.view.MenuItem.OnMenuItemClickListener onmenuitemclicklistener)
    {
        ...
        menuitem.setOnMenuItemClickListener(onmenuitemclicklistenerwrapper);
        return this;
    }
