...
class ActionBarImplICS extends android.support.v7.app.ActionBar
{
        ...
        implements android.app.ActionBar.TabListener
    {
        ...
        public void onTabReselected(android.app.ActionBar.Tab tab, android.app.FragmentTransaction fragmenttransaction)
        {
            ...
            {
                fragmenttransaction1 = getActiveTransaction();
            } else
            {
                fragmenttransaction1 = null;
            }
            tablistener.onTabReselected(this, fragmenttransaction1);
        ...
        public void onTabSelected(android.app.ActionBar.Tab tab, android.app.FragmentTransaction fragmenttransaction)
        {
            ...
            tablistener.onTabSelected(this, fragmenttransaction1);
            commitActiveTransaction();
        }
        ...
        public void onTabUnselected(android.app.ActionBar.Tab tab, android.app.FragmentTransaction fragmenttransaction)
        {
            ...
            tablistener.onTabUnselected(this, fragmenttransaction1);
        }
...
_L2:
        ...
        ArrayList arraylist = mAddedMenuVisWrappers;
        int j = i - 1;
        arraylist.remove(i);
        i = j;
_L4:
...
_L3:
    ...
    public void addOnMenuVisibilityListener(ActionBar.OnMenuVisibilityListener onmenuvisibilitylistener)
    {
        if (onmenuvisibilitylistener != null)
        {
            ...
            mAddedMenuVisWrappers.add(new WeakReference(onmenuvisibilitylistenerwrapper));
            mActionBar.addOnMenuVisibilityListener(onmenuvisibilitylistenerwrapper);
        }
    }
...
_L1:
        ...
        return null;
_L2:
        if ((viewgroup = (ViewGroup)view.getParent()).getChildCount() != 2) goto _L1; else goto _L3
_L3:
        ...
        {
            mHomeActionView = (ImageView)view3;
        }
    ...
    {
        OnMenuVisibilityListenerWrapper onmenuvisibilitylistenerwrapper = findAndRemoveMenuVisWrapper(onmenuvisibilitylistener);
        mActionBar.removeOnMenuVisibilityListener(onmenuvisibilitylistenerwrapper);
    }
...
label0:
    ...
    public void setListNavigationCallbacks(SpinnerAdapter spinneradapter, ActionBar.OnNavigationListener onnavigationlistener)
    {
        ...
        OnNavigationListenerWrapper onnavigationlistenerwrapper;
        if (onnavigationlistener != null)
        {
            onnavigationlistenerwrapper = new OnNavigationListenerWrapper(onnavigationlistener);
        } else
        {
            onnavigationlistenerwrapper = null;
        }
        actionbar.setListNavigationCallbacks(spinneradapter, onnavigationlistenerwrapper);
    }
