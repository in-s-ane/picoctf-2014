...
label0:
    ...
    void animateToMode(boolean flag)
    {
        ...
        if (mTabScrollView != null && !mActionView.hasEmbeddedTabs() && mActionView.isCollapsed())
        {
            ...
            scrollingtabcontainerview.setVisibility(byte0);
        }
    }
    ...
    public void doHide(boolean flag)
    {
        ...
        if (mTopVisibilityView.getVisibility() != 8)
        {
            ...
            if (flag1)
            {
                android.view.animation.Animation animation1 = AnimationUtils.loadAnimation(mContext, android.support.v7.appcompat.R.anim.abc_slide_out_top);
                mTopVisibilityView.startAnimation(animation1);
            }
            ...
            if (mSplitView != null && mSplitView.getVisibility() != 8)
            {
                if (flag1)
                {
                    android.view.animation.Animation animation = AnimationUtils.loadAnimation(mContext, android.support.v7.appcompat.R.anim.abc_slide_out_bottom);
                    mSplitView.startAnimation(animation);
                }
    ...
    public void doShow(boolean flag)
    {
        ...
        if (mTopVisibilityView.getVisibility() != 0)
        {
            ...
            if (flag1)
            {
                android.view.animation.Animation animation1 = AnimationUtils.loadAnimation(mContext, android.support.v7.appcompat.R.anim.abc_slide_in_top);
                mTopVisibilityView.startAnimation(animation1);
            }
            ...
            if (mSplitView != null && mSplitView.getVisibility() != 0)
            {
                if (flag1)
                {
                    android.view.animation.Animation animation = AnimationUtils.loadAnimation(mContext, android.support.v7.appcompat.R.anim.abc_slide_in_bottom);
                    mSplitView.startAnimation(animation);
                }
